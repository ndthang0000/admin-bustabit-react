  ...
  return (
    <>
      ...
      <CTable align="middle" className="mb-6 border" hover responsive>
        ...
        <CTableBody>
          {dataBet.length == 0 ? <span className="text-center" style={{ fontWeight: 'bold', fontSize: 20 }}>Chưa có ai bet</span> :
      ...
      <CRow>
        <CCol xs>
          <CCard className="mb-4 mt-4">
            <CCardHeader>THỐNG KÊ HỆ THỐNG</CCardHeader>
            <CCardBody>
              <CRow>
                  ...
                  <CRow>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-info py-1 px-3">
                        <div className="text-medium-emphasis small">Tổng user hệ thống</div>
                        <div className="fs-5 fw-semibold">12</div>
                      </div>
                    </CCol>
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-danger py-1 px-3 mb-3">
                        <div className="text-medium-emphasis small">Người chơi mới đăng ký</div>
                  ...
                  <CRow>
                    ...
                    <CCol sm={6}>
                      <div className="border-start border-start-4 border-start-success py-1 px-3 mb-3">
                        <div className="text-medium-emphasis small">Volume bet hôm nay</div>
